...
number=st.number_input('请输入你要分成几个价格段:')
...
chose = st.radio('请选择需要分析的变量？', ['Type','Capacity(L) /Loading KG','Width(cm)','Depth(cm)','Height(cm)'],horizontal=True,key='variables')
...
pricetables.insert(9,'mprice23',mid) #插入备注列

mid=pricetables['pricegr_23']   #取备注列的值
pricetables.pop('pricegr_23')  #删除备注列
pricetables.insert(9,'pricegr_23',mid) #插入备注列
